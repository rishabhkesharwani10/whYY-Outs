...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black/50 border-t border-brand-gold/10 font-sans z-10">
      <div className="container mx-auto px-6 lg:px-8 py-12 text-brand-light">
        ...
        <div className="mt-12 pt-8 border-t border-brand-gold/10 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-brand-light/60 hover:text-white transition-colors duration-300">Facebook</a>
            <a href="#" className="text-brand-light/60 hover:text-white transition-colors duration-300">Pinterest</a>
          </div>
        </div>
      </div>
    </footer>
