...
const SecurityPolicyPage: React.FC = () => {
    ...
    return (
        <LegalPageLayout title="Security Policy" lastUpdated="October 17, 2024">
            ...
            <p className="text-brand-light/90 leading-relaxed">If you believe you have found a security vulnerability in our service, please contact us immediately at whyyouts@gmail.com. We will investigate all legitimate reports and do our best to quickly fix the problem.</p>
        </LegalPageLayout>
    );
};
