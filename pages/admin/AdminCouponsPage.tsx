...
const AdminCouponsPage: React.FC = () => {
    ...
    const fetchCoupons = useCallback(async () => {
        ...
        try {
            ...
            // Step 2: Fetch all used coupon codes from orders
            ...
            // Step 3: Create a usage count map
            ...
            // Step 4: Merge usage counts into coupon data
                        ...
                        <div className="bg-black/30 border border-brand-gold/20 rounded-lg overflow-x-auto">
                            <table className="w-full text-left min-w-[640px]">
                                 ...
                                 <tbody className="divide-y divide-brand-gold/20">
                                    {loading ? (
                                        <tr><td colSpan={7} className="text-center p-8 text-brand-light/70">Loading...</td></tr>
