...
const ReturnPolicyPage: React.FC = () => {
    ...
    return (
        <LegalPageLayout title="Return Policy" lastUpdated="October 17, 2024">
            <p className="text-brand-light/90 leading-relaxed">At whYYOuts, we are committed to ensuring your satisfaction with every purchase. If you are not entirely satisfied with your purchase, we're here to help.</p>
            ...
            <p className="text-brand-light/90 leading-relaxed mt-2">If your return is approved, we will initiate a refund to your original method of payment. You will receive the credit within a certain amount of days, depending on your card issuer's policies.</p>

            <H2>Shipping Costs</H2>
            <p className="text-brand-light/90 leading-relaxed">You will be responsible for paying for your own shipping costs for returning your item. Shipping costs are non-refundable. If you receive a refund, the cost of return shipping may be deducted from your refund.</p>

            <H2>Contact Us</H2>
            <p className="text-brand-light/90 leading-relaxed">If you have any questions on how to return your item to us, contact us at whyyouts@gmail.com.</p>
        </LegalPageLayout>
    );
};
