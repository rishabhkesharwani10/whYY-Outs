...
const PrivacyPolicyPage: React.FC = () => {
    ...
    return (
        <LegalPageLayout title="Privacy Policy" lastUpdated="October 17, 2024">
            ...
            <p className="text-brand-light/90 leading-relaxed">The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like us to delete User Provided Data that you have provided via the Application, please contact them at whyyouts@gmail.com and we will respond in a reasonable time.</p>
            
            <H2>Children's Privacy</H2>
            <p className="text-brand-light/90 leading-relaxed">The Service Provider does not use the Application to knowingly solicit data from or market to children under the age of 13. The Application does not address anyone under the age of 13. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider (whyyouts@gmail.com) so that we will be able to take the necessary actions.</p>
            ...
            <H2>Contact Us</H2>
            <p className="text-brand-light/90 leading-relaxed">If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact the Service Provider via email at whyyouts@gmail.com.</p>
        </LegalPageLayout>
    );
};
